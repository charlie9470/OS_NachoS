...
int SysWrite(char* write_buf, int size, int id)
{
	return kernel->fileSystem->writefile(write_buf, size, id);
}
int SysRead(char* Read_buf, int size, int id)
{
	return kernel->fileSystem->readfile(Read_buf, size, id);
}
int SysClose(int id)
{
